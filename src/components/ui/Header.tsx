            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to="/" className="flex items-center">
                        <img src={keyboardLogo} className="h-8 mr-3" alt="Logo"/>
                        <span
                            className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Solo on Board</span>
                    </Link>
                    <div className="flex items-center md:order-2">
                        <button type="button"
                            ...
                            <img className="w-8 h-8 rounded-full" src={'https://api.dicebear.com/6.x/lorelei/svg'}
                                 alt="user photo"/>
                        </button>
                        {/*// Dropdown menu*/}
                        <div
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                        ...
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <NavLink to={PathPages.home}
                                         className={cn("block py-2 pl-3 pr-4 text-white bg-blue-700  rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500",{'bg-blue-700':isActive})}
                                   aria-current="page">
                                    Home
                                </NavLink>
                            </li>
