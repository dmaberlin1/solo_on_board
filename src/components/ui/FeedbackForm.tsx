...
const FeedbackForm: FC = () => {
    ...
    const onSubmitFeedback:SubmitHandler<IFeedbackForm>=data=>{
        //there should be an e-mail sent
        console.log(data)
    }
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a
                    ...
                    Let us know.</p>
                <form action="#" className="space-y-8" onSubmit={handleSubmit(onSubmitFeedback)}>
                    <div>
                        <label htmlFor="email"
