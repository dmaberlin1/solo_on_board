...
const LoginForm = () => {
    const auth=getAuth()
    const formData: ILoginFormData = {email: '', password: ''}
    const [responseBody, setResponseBody] = useState<ILoginFormData>(formData)
    ...
    const onSubmitHandlerLogin = (event: FormEvent<HTMLFormElement>) => {
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={onSubmitHandlerLogin}
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                Don’t have an account yet? <NavLink to={PathPages.home+PathPages.signup}
